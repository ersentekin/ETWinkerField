...
// ETWinkerField
#define COCOAPODS_POD_AVAILABLE_ETWinkerField
#define COCOAPODS_VERSION_MAJOR_ETWinkerField 0
#define COCOAPODS_VERSION_MINOR_ETWinkerField 1
#define COCOAPODS_VERSION_PATCH_ETWinkerField 0
